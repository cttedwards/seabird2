#' $Id: get.sbd.command.R 1750 2007-11-13 00:45:01Z adunn $
#'
#' @export
#'
"get.sbd.command"<-
function(object,command,label,where.subcommand) {
  ...
  if(class(object)!="SeaBirdSBDfile") stop("The input object is not of class 'SeaBirdSBDfile'. See the function 'extract.sbd.file' for details\n")
